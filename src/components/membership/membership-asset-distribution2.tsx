    ...
    <div>
      <div className="flex justify-between items-end mb-2">
        <h3 className="text-lg font-semibold text-foreground">
          같은 등급 멤버들은, 현금일까 코인일까?
        </h3>
        <div className="text-right">
            <span className="text-muted-foreground text-sm">나의 자산 비중</span>
            <p className="text-2xl font-bold text-primary">{myAssetPercentage}%</p>
        </div>
      </div>
      <p className="text-muted-foreground mb-6">
        같은 등급 멤버들의 실제 포트폴리오 구성을 분석하여 나의 투자 성향과 비교해보세요.
      </p>
